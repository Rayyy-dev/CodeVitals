...
export async function getRepositories(accessToken: string): Promise<Repository[]> {
  ...
  try {
    ...
    return data.map(repo => ({
      ...
      metrics: analyzeMetrics(repo),
      suggestions: generateSuggestions(repo),
      avatar_url: repo.owner.avatar_url,
      topIssue: getTopIssue(repo),
      oldestPR: getOldestPR(repo),
...
function getTopIssue(repo: any): string {
  // Implement logic to get the top issue
  return "Top issue placeholder";
}

function getOldestPR(repo: any): string {
  // Implement logic to get the oldest PR
  return "Oldest PR placeholder";
}

function getMostComplexFunction(repo: any): string {
  // Implement logic to identify the most complex function
  return "Most complex function placeholder";
}

function getMostDuplicatedArea(repo: any): string {
  // Implement logic to identify the most duplicated area
  return "Most duplicated area placeholder";
}
