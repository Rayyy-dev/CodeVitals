  ...
  function getMetricRecommendations(key: string, value: number): string[] {
    switch (key) {
      case 'testcoverage':
        ...
        return [
          `Increase test coverage for ${repository.name}. Start by adding tests for critical components and functions.`,
      ...
      case 'openissuesandprs':
        return [
          `Address the top issue: "${repository.topIssue}"`,
          `Review and provide feedback on the oldest PR: "${repository.oldestPR}"`,
          `Set up a weekly triage session to manage open issues and PRs.`
        ];
      case 'codecomplexity':
        return [
          `Review and refactor complex areas of your codebase, particularly in ${repository.complexFunction}.`,
      ...
      case 'codeduplication':
        return [
          `Address code duplication, particularly in ${repository.duplicateArea}.`,
      ...
      default:
        return [
          `Review and improve the ${key} aspect of your ${repository.name} repository.`,
          ...
          >
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <ol className="list-decimal list-inside mt-2">
                {repository.suggestions.slice(0, 3).map((suggestion, index) => (
