          ...
          >
            <div className="flex items-center bg-white rounded-full shadow-lg overflow-hidden">
              <input
                ...
                className="appearance-none w-full py-3 px-6 text-gray-700 leading-tight focus:outline-none"
              />
              <button
                type="submit"
                disabled={isLoading || !isValidUrl}
                className={`flex-shrink-0 ${
                  isValidUrl ? 'bg-blue-500 hover:bg-blue-600' : 'bg-gray-400 cursor-not-allowed'
                } text-white font-bold py-3 px-6 rounded-full focus:outline-none focus:shadow-outline transition-colors duration-200 ease-in-out`}
              >
