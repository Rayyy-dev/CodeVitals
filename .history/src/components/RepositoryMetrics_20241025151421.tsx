...
export default function RepositoryMetrics({ repository }: RepositoryMetricsProps) {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6">
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold mb-4">Personalized Suggestions</h3>
        <div className="bg-gray-100 rounded-lg p-4">
      ...
      {isReportOpen && (
        ...
        >
          ...
          >
            ...
            <div className="mt-6 border-t pt-4">
              <h3 className="text-xl font-semibold mb-2">General Suggestions</h3>
              <p>Here are some general improvement suggestions for your repository:</p>
              <ul className="list-disc list-inside mt-2">
                {repository.suggestions.map((suggestion, index) => (
                  <li key={index} className="ml-4 mb-2">{suggestion}</li>
                ))}
