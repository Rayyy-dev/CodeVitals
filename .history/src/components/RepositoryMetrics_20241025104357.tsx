import { Repository } from '../types'; // Adjusted the import path to a relative path
...
const CodeVitalsLogo = () => (
  <svg width="200" height="50" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="100" y="35" fontFamily="Arial" fontSize="24" fontWeight="bold" fill="#1E3A8A">CodeVitals</text>
  </svg>
);
