...
export default function RepositoryMetrics({ repository }: RepositoryMetricsProps) {
  ...
  const metrics = [
    { name: 'Code Complexity', value: repository.metrics.codeComplexity, color: 'bg-yellow-400', icon: FiCode },
    { name: 'Code Duplication', value: repository.metrics.codeDuplication, color: 'bg-yellow-400', icon: FiCopy },
    { name: 'Code Style Consistency', value: repository.metrics.codeStyleConsistency, color: 'bg-green-400', icon: FiCheck },
    { name: 'Test Coverage', value: repository.metrics.testCoverage, color: 'bg-red-400', icon: FiFileText },
    { name: 'Open Issues and PRs', value: repository.metrics.openIssuesAndPRs, color: 'bg-yellow-400', icon: FiGitPullRequest },
    { name: 'Dependency Management', value: repository.metrics.dependencyManagement, color: 'bg-yellow-400', icon: FiShield },
  ];
