...
export default function RepositoryMetrics({ repository }: RepositoryMetricsProps) {
  ...
  if (!repository.metrics || Object.values(repository.metrics).every(value => value === 0)) {
    return (
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-2xl font-semibold mb-4">{repository.name}</h2>
        <p className="text-gray-600 mb-4">This repository is empty or has no metrics available.</p>
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6">
      ...
      <div className="mt-6">
        ...
        <div className="bg-gray-100 rounded-lg p-4">
          {repository.suggestions && repository.suggestions.length > 0 ? (
          ...
          >
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <ul className="list-disc list-inside mt-2">
                {repository.personalizedSuggestions && repository.personalizedSuggestions.length > 0 ? (
