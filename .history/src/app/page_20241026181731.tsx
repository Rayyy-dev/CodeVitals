...
import { FiGithub, FiCpu, FiGitBranch, FiGitPullRequest, FiArrowRight, FiChevronRight, FiFileText, FiUsers, FiBarChart2 } from 'react-icons/fi';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-4 text-gray-900">
                Ready to elevate your <span className="text-blue-600">code quality</span>?
              </h2>
              <p className="text-xl text-gray-600 mb-8">
                Join thousands of developers already using Code Vitals to optimize their code.
              </p>
              <button
                className="bg-blue-600 text-white text-lg px-8 py-3 rounded-full hover:bg-blue-700 transition-colors duration-300 flex items-center justify-center mx-auto"
                onClick={handleSignIn}
