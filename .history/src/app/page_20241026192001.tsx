...
const GridItem = ({ icon: Icon, title, description, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative p-6 bg-white rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
    >
