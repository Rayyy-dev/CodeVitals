        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center bg-gradient-to-br from-gray-900 to-gray-800 text-white py-16 rounded-3xl shadow-xl">
              ...
              <button
                className="group bg-blue-600 text-white hover:bg-blue-700 text-lg px-10 py-4 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
                onClick={handleSignIn}
              >
