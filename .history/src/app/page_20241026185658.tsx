...
const ButtonWave = () => (
  <div className="absolute -bottom-12 left-0 w-full overflow-hidden">
    <svg className="w-full h-auto" viewBox="0 0 1440 120" preserveAspectRatio="none">
      <path fill="#E6F3FF" fillOpacity="1" d="M0,0L48,5.3C96,11,192,21,288,37.3C384,53,480,75,576,80C672,85,768,75,864,64C960,53,1056,43,1152,42.7C1248,43,1344,53,1392,58.7L1440,64L1440,120L1392,120C1344,120,1248,120,1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z"></path>
    </svg>
  </div>
);
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              ...
              <button
                className="group bg-gray-900 text-white hover:bg-gray-800 text-lg px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
                onClick={handleSignIn}
              >
