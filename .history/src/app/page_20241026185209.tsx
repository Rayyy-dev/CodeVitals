        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                Elevate Your <span className="text-blue-600 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-700">Code Quality</span> with AI
              </motion.h1>
              <motion.p 
              ...
              >
                Harness AI-powered insights to perfect your GitHub repositories in real-time. Boost productivity and code quality effortlessly.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <button
                  className="bg-blue-600 text-white text-lg px-10 py-4 rounded-full hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
            ...
            <div className="text-center bg-blue-600 text-white py-16 rounded-3xl shadow-2xl">
              <h2 className="text-3xl font-bold mb-4">
                Join the coding <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-yellow-500">revolution</span>
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Thousands of developers are already optimizing their code with Code Vitals. Don't miss out on the future of coding.
              </p>
              <button
                className="group bg-white text-blue-600 hover:bg-gray-100 text-lg px-10 py-4 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
                onClick={handleSignIn}
              >
