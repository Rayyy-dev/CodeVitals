...
const FeatureCard = ({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) => (
  <motion.div
    ...
    className="group relative bg-white p-8 rounded-2xl transition-all duration-300 hover:bg-blue-50"
  >
    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-t-2xl" />
    ...
    <p className="text-gray-600 group-hover:text-blue-800 transition-colors duration-300">{description}</p>
  </motion.div>
);
