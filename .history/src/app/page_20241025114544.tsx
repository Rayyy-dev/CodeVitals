    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <main className="flex-grow container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="mx-auto block bg-black text-white px-8 py-3 rounded-lg font-semibold text-lg shadow-md hover:bg-gray-800 transition-all duration-300 flex items-center"
        >
