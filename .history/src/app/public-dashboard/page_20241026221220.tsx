...
export default function PublicDashboard({ searchParams }: { searchParams: { repo?: string } }) {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <PublicDashboardContent repoUrl={searchParams.repo} />
    </Suspense>
  );
}

async function PublicDashboardContent({ repoUrl }: { repoUrl: string }) {
