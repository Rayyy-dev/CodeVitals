  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold mb-4 text-gray-900">Elevate Your Code</h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Analyze and improve your GitHub repository health with precision and insight.
        </p>
      </div>
      <button
        onClick={handleSignIn}
        className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold text-lg shadow-md hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center"
      >
