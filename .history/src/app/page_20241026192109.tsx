...
const FeatureCard = ({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) => {
  ...
  return (
    <motion.div
      ...
      className="h-full bg-white backdrop-filter backdrop-blur-lg bg-opacity-70 border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-blue-300"
    >
      <div className="p-6">
...
const WorkflowCard = ({ icon: Icon, title, description, index }) => {
  const controls = useAnimation();
  const [ref, inView] = useInView({
    threshold: 0.1,
    triggerOnce: true,
  ...
  return (
    <motion.div
      ...
      className="relative bg-white backdrop-filter backdrop-blur-lg bg-opacity-70 border border-gray-200 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:border-blue-300"
    >
      ...
      <main className="relative z-10">
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-20 bg-gradient-to-br from-blue-50 to-white rounded-3xl shadow-xl p-10">
              <motion.h2
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <WorkflowCard key={index} {...item} index={index} />
                ))}
              </div>
            </div>
