...
const BackgroundDecoration = () => (
  <div className="absolute inset-0 z-0 overflow-hidden">
    <div className="absolute top-0 left-0 w-full h-2/3 bg-gradient-to-b from-blue-50 to-white"></div>
    <div className="absolute bottom-0 left-0 w-full h-1/3 bg-white"></div>
    <svg className="absolute top-0 left-0 w-full h-auto text-blue-100 opacity-50" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
      <path fill="currentColor" d="M0,192L48,197.3C96,203,192,213,288,229.3C384,245,480,267,576,250.7C672,235,768,181,864,181.3C960,181,1056,235,1152,234.7C1248,235,1344,181,1392,154.7L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
    </svg>
  </div>
);
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                <button
                  className="bg-blue-600 text-white text-lg px-8 py-3 rounded-full hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
            ...
            <div className="mb-20 bg-blue-50 py-16 rounded-3xl shadow-inner">
            ...
            <div className="text-center bg-gray-900 text-white py-16 rounded-3xl shadow-xl">
              ...
              <button
                className="group bg-white text-gray-900 hover:bg-gray-100 text-lg px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
                onClick={handleSignIn}
              >
