...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-br from-gray-50 to-blue-100 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl w-full">
        {[
          ...
          <div key={index} className="bg-white p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:bg-blue-50 hover:-translate-y-1 cursor-pointer">
            <div className="text-4xl mb-4">{feature.icon}</div>
            <h3 className="text-2xl font-bold mb-4 text-gray-800 hover:text-blue-600 transition-colors duration-300">{feature.title}</h3>
