    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col">
      ...
      <header className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
        <div className="flex items-center">
          <FiCpu className="text-blue-600 w-8 h-8 mr-2" />
          <span className="text-2xl font-bold text-blue-600">Code Vitals</span>
        </div>
        <button
          onClick={handleSignIn}
          className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-full transition-colors duration-300 flex items-center"
        >
          <FiGithub className="mr-2" />
          Login with GitHub
        </button>
      </header>
      <main className="flex-grow flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-6xl font-bold text-blue-600 mb-4">Elevate Your Code Quality</h1>
