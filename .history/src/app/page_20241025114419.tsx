    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-blue-100">
      <main className="flex-grow container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="mx-auto block bg-black text-white px-10 py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-800 hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center"
        >
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center text-gray-400">
            © 2024 Code Vitals. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
