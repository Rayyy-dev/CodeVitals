...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <button
        ...
        className="bg-black text-white px-10 py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 flex items-center"
      >
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl w-full">
        {[
          { title: 'AI-Powered Analysis', description: 'Get a comprehensive view of your repository health using advanced algorithms' },
          { title: 'Actionable Insights', description: 'Receive tailored recommendations to improve code quality and efficiency' },
          { title: 'Real-time Tracking', description: 'Monitor your repository\'s health and progress over time with live updates' },
        ].map((feature, index) => (
          <div key={index} className="bg-white p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl">
