...
import { FiGithub, FiCpu, FiGitBranch, FiGitPullRequest, FiArrowRight, FiChevronRight, FiFileText, FiUsers } from 'react-icons/fi';
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="py-20 bg-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-bold text-center mb-12">How Code Vitals Works</h2>
