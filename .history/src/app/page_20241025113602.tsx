...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-br from-gray-50 to-blue-50 px-4 sm:px-6 lg:px-8">
      ...
      <button
        ...
        className="bg-black text-white px-8 py-3 sm:px-10 sm:py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 flex items-center"
      >
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
        {[
          { title: 'AI-Powered Analysis', description: 'Get a comprehensive view of your repository health using advanced algorithms', icon: '🧠' },
          { title: 'Actionable Insights', description: 'Receive tailored recommendations to improve code quality and efficiency', icon: '💡' },
          { title: 'Real-time Tracking', description: 'Monitor your repository's health and progress over time with live updates', icon: '📊' },
        ].map((feature, index) => (
          <div key={index} className="bg-white p-6 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
